...
header("EVILNAE 3.1.0 CHARACTER LIVE FIX — V3")
...
# The 3.0.2 prerequisite and 3.1.0 may create backups in the same second.
# Never abort because of a timestamp collision; append _01, _02, ...
if backup_directory.exists():
    ...
    while True:
        ...
        if suffix > 99:
            fail(
                "Could not find a free backup directory suffix "

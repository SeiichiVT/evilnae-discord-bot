...
def ensure_302_base():
    ...
    print("[INFO] Local base is 3.0.1. Applying existing 3.0.2 prerequisite first...")
    ...
    if result.returncode != 0:
        fail(f"3.0.2 prerequisite installer failed with exit code {result.returncode}")
    ...
    ok("3.0.2 prerequisite applied")


header("EVILNAE 3.1.0 CHARACTER LIVE FIX")
